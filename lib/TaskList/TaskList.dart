  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        title: new Text(
          'Задачи',
          style: TextStyle(color: Colors.red, fontFamily: "Nexa"),
        ),
        actions: <Widget>[
          IconButton(
            icon: Icon(
              ...
              case ConnectionState.done:
                if (snapshot.hasError)
                  return Column(
                    ...
                    children: <Widget>[
                      Container(
                        child: Image.asset('lib/img/duck.png'),
                      ),
                      Container(child: Text('Упс......'))
                    ],
                  );
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                            ...
                            leading: Container(
                              ...
                              child: Icon(Icons.timer, color: Colors.pink),
                            ),
                            title: Text(
                              messages.subject,
